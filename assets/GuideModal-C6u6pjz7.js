import{u as v,o as y,c as M,a as s,b as t,j as o,k as a,t as C,F as x,l as S,e as w}from"./index-DqbSkxop.js";import{u as T}from"./dialog-VRAlKAGu.js";import{_ as f}from"./AccordionItem-BWPJbBwH.js";import{_ as g}from"./TooltipItem-BXet3i2k.js";import{_ as b}from"./TextfieldItem-DhH8uGow.js";import"./chkDevice-Dk95wBeW.js";const O={class:"modal-header"},I=["id"],$=["id"],D={class:"modal-body-inner"},A={class:"form-wrap"},j={__name:"ModalSample",props:{modalId:{type:String},modalType:{type:String},modalData:{type:Object}},setup(p){const r=v(),{alert:e,confirm:m}=T(),i=async()=>{await m({modalId:"ConfirmModal",modalType:"confirm",modalCont:"진행하시겠습니까?",modalOkText:"",modalCancelText:""})?await e({modalId:"AlertModal",modalType:"alert",modalCont:"완료되었습니다.",modalOkText:"",modalOkAct:()=>{console.log("alert ok!!")}}):console.log("confirm cancel!!")};function d(){r.close()}function u(c){i()}return(c,n)=>(y(),M(x,null,[s("header",O,[s("h1",{id:`${p.modalId}_title`,class:"modal-title"},[t(g,{id:"TipSample1","tip-title":"Modal Test"},{default:o(()=>[...n[0]||(n[0]=[s("p",null,"개인정보 처리목적 : 보험계약 상담, 보험계약 인수여부 결정을 위한 판단 등",-1)])]),_:1})],8,I)]),s("div",{id:`${p.modalId}_desc`,class:"modal-body"},[s("div",D,[s("div",null,[a(" receive data : "+C(p.modalData),1),n[2]||(n[2]=s("br",null,null,-1)),n[3]||(n[3]=s("br",null,null,-1)),n[4]||(n[4]=a(" Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ",-1)),n[5]||(n[5]=s("a",{href:"#"},"anchor",-1)),n[6]||(n[6]=s("br",null,null,-1)),n[7]||(n[7]=s("button",{type:"button"},"button",-1)),n[8]||(n[8]=s("br",null,null,-1)),t(g,{id:"TipSample2","tip-title":"개인정보 처리목적","tip-click":!0},{default:o(()=>[...n[1]||(n[1]=[s("p",null,"개인정보 처리목적 : 보험계약 상담, 보험계약 인수여부 결정을 위한 판단 등",-1)])]),_:1}),s("div",A,[t(b,{id:`${p.modalId}-inpName`,label:"Input Label",name:"name",placeholder:"example...",autocomplete:"off"},null,8,["id"]),t(b,{type:"textarea",id:`${p.modalId}-textfield`,label:"Textarea Label",name:"txtarea-name",placeholder:"Textarea example...",maxlength:"300"},null,8,["id"])]),n[9]||(n[9]=a(" Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ",-1))])])],8,$),s("footer",{class:"modal-footer"},[s("button",{type:"button",class:"modal-btn-gray",onClick:d},[...n[10]||(n[10]=[s("span",null,"취소",-1)])]),s("button",{type:"button",class:"modal-btn-primary",onClick:u},[...n[11]||(n[11]=[s("span",null,"확인",-1)])])])],64))}},q={class:"contents"},L={class:"guide-cont"},B={class:"guide-cont"},N={class:"guide-cont type-row"},F={class:"guide-cont"},H={__name:"GuideModal",setup(p){const r=v(),{alert:e,confirm:m}=T(),i=()=>{e({modalId:"AlertModal",modalCont:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.",modalOkText:"",modalOkAct:()=>{console.log("alert ok!!")}})},d=async()=>{await m({modalId:"ConfirmModal",modalCont:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br /> Do you want to ... ?",modalOkText:"",modalCancelText:""})?await e({modalId:"AlertModal",modalCont:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.",modalOkText:"",modalOkAct:()=>{console.log("alert ok!!")}}):console.log("confirm cancel!!")},u=w([{label:"sample",value:"1"}]),c=n=>{r.open(j,{modalId:n.id,modalType:n.type,modalData:u})};return S(()=>{}),(n,l)=>(y(),M("div",q,[l[14]||(l[14]=s("h2",{class:"guide-title"},"Modal",-1)),l[15]||(l[15]=s("h3",{class:"guide-stitle"},"Alert modal",-1)),s("div",{class:"guide-cont type-row"},[s("button",{type:"button",class:"btn-primary",onClick:i},[...l[3]||(l[3]=[s("span",null,"Alert dialog",-1)])])]),s("div",L,[t(f,{id:"ModalAlert"},{accoTitle:o(()=>[...l[4]||(l[4]=[a("Code 보기",-1)])]),accoPanel:o(()=>[...l[5]||(l[5]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"comment"},"// modal store 파일 및 alert/confirm 관련 util js 파일 import"),a(`
...
`),s("span",{class:"tag"},"const"),a(),s("span",{class:"func"},"alertModal"),a(" = "),s("span",{class:"mark"},"()"),a(),s("span",{class:"tag"},"=>"),a(),s("span",{class:"mark"},"{"),a(`
  ...
  `),s("span",{class:"func"},")"),a(`;
`),s("span",{class:"mark"},"}"),a(`;
`)])],-1)])]),_:1})]),l[16]||(l[16]=s("h3",{class:"guide-stitle"},"Confirm modal",-1)),s("div",{class:"guide-cont type-row"},[s("button",{type:"button",class:"btn-primary",onClick:d},[...l[6]||(l[6]=[s("span",null,"Confirm dialog",-1)])])]),s("div",B,[t(f,{id:"ModalConfirm"},{accoTitle:o(()=>[...l[7]||(l[7]=[a("Code 보기",-1)])]),accoPanel:o(()=>[...l[8]||(l[8]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"comment"},"// modal store 파일 및 alert/confirm 관련 util js 파일 import"),a(`
`),s("span",{class:"import"},"import"),a(),s("span",{class:"mark"},[a("{ "),s("span",{class:"props"},"useDialog"),a(" }")]),a(),s("span",{class:"import"},"from"),a(),s("span",{class:"val"},"'@/assets/js/dialog'"),a(`;
...
`),s("span",{class:"tag"},"const"),a(),s("span",{class:"func"},"confirmModal"),a(" = "),s("span",{class:"tag"},[a("async "),s("span",{class:"mark"},"()"),a(" =>")]),a(),s("span",{class:"mark"},"{"),a(`
  ...
  `),s("span",{class:"func"},"}"),a(`
`),s("span",{class:"mark"},"}"),a(`;
`)])],-1)])]),_:1})]),l[17]||(l[17]=s("h3",{class:"guide-stitle"},"Normal modal",-1)),s("div",N,[s("button",{type:"button",class:"btn-primary","aria-haspopup":"dialog","aria-controls":"SampleModal",onClick:l[0]||(l[0]=k=>c({id:"SampleModal",type:"full"}))},[...l[9]||(l[9]=[s("span",null,"Type: Full",-1)])]),s("button",{type:"button",class:"btn-primary","aria-haspopup":"dialog","aria-controls":"SampleTopModal",onClick:l[1]||(l[1]=k=>c({id:"SampleTopModal",type:"top"}))},[...l[10]||(l[10]=[s("span",null,"Type: Top",-1)])]),s("button",{type:"button",class:"btn-primary","aria-haspopup":"dialog","aria-controls":"SampleBottomModal",onClick:l[2]||(l[2]=k=>c({id:"SampleBottomModal",type:"bottom"}))},[...l[11]||(l[11]=[s("span",null,"Type: Bottom",-1)])])]),s("div",F,[t(f,{id:"Modal"},{accoTitle:o(()=>[...l[12]||(l[12]=[a("Code 보기",-1)])]),accoPanel:o(()=>[...l[13]||(l[13]=[s("div",{class:"guide-info html"},[s("pre",null,[a(""),s("span",{class:"arrow"},"<"),s("span",{class:"tag"},"button"),a(`
