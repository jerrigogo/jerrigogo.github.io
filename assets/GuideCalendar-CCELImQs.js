import{_ as o}from"./AccordionItem-BRnqQSl5.js";import{_ as r}from"./CalendarItem-CBdijrly.js";import{e as m,f as M,d as x,c as $,a as s,b as l,j as p,o as P,k as a}from"./index-CkgtBbL2.js";const V={class:"contents"},B={class:"guide-cont"},F={class:"guide-cont"},R={class:"guide-cont"},T={class:"guide-cont"},y={__name:"GuideCalendar",setup(j){const g=m("2026-03-16"),c=e=>{console.log(e)},i=m({minDate:null,maxDate:null}),v=()=>{let e=20,n=24;const t=new Date,k=new Date(new Date(t).setDate(new Date(t).getDate()-e)),w=new Date(new Date(t).setDate(new Date(t).getDate()+n)),f=u=>{const b=u.getFullYear(),C=String(u.getMonth()+1).padStart(2,"0"),S=String(u.getDate()).padStart(2,"0");return`${b}-${C}-${S}`};i.value.minDate=f(k),i.value.maxDate=f(w)},d=m({start:"2026-02-14",end:"2026-03-15"}),D=m(M(()=>`${d.value.start} ~ ${d.value.end}`));return x(()=>{v()}),(e,n)=>(P(),$("div",V,[n[8]||(n[8]=s("h2",{class:"guide-title"},"Calendar",-1)),n[9]||(n[9]=s("h3",{class:"guide-stitle"},"Default",-1)),s("div",B,[l(r,{id:"CalSample1",onCalAct:c}),l(o,{id:"CalendarBasic"},{accoTitle:p(()=>[...n[0]||(n[0]=[a("Code 보기",-1)])]),accoPanel:p(()=>[...n[1]||(n[1]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"comment"},"// component import"),a(`
...
`),s("span",{class:"arrow"},"<"),s("span",{class:"component"},"calendar-item"),a(`
  ...
  @`),s("span",{class:"props"},"cal-act"),a('="'),s("span",{class:"func"},"selectDate"),a(`"
`),s("span",{class:"arrow"},"/>"),a(`
`)])],-1)])]),_:1})]),n[11]||(n[11]=s("h3",{class:"guide-stitle"},"날짜 제한 설정: minDate, maxDate",-1)),s("div",R,[l(r,{id:"CalSample3","limit-date":i.value,onCalAct:c},null,8,["limit-date"]),l(o,{id:"CalendarLimit"},{accoTitle:p(()=>[...n[4]||(n[4]=[a("Code 보기",-1)])]),accoPanel:p(()=>[...n[5]||(n[5]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"import"},"import"),a(),s("span",{class:"mark"},"{"),a(),s("span",{class:"props"},"ref"),a(", "),s("span",{class:"props"},"onBeforeMount"),a(),s("span",{class:"mark"},"}"),a(" = "),s("span",{class:"val"},"'vue'"),a(`;
...
`),s("span",{class:"arrow"},"<"),s("span",{class:"component"},"calendar-item"),a(`
  ...
  @`),s("span",{class:"props"},"cal-act"),a('="'),s("span",{class:"func"},"selectDate"),a(`"
`),s("span",{class:"arrow"},"/>"),a(`
`)])],-1)])]),_:1})]),n[12]||(n[12]=s("h3",{class:"guide-stitle"},"날짜 영역(기간) 선택",-1)),s("div",T,[l(r,{id:"CalSample4",range:d.value,"define-date":D.value,onCalAct:c},null,8,["range","define-date"]),l(o,{id:"CalendarPeriod"},{accoTitle:p(()=>[...n[6]||(n[6]=[a("Code 보기",-1)])]),accoPanel:p(()=>[...n[7]||(n[7]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"comment"},"// 날짜 범위 샘플"),a(`
