import{_ as o}from"./AccordionItem-Dge7R2hS.js";import{_ as r}from"./CalendarItem-BIy0QwBm.js";import{r as m,f as M,d as x,c as $,a as s,b as l,j as p,F as P,o as V,k as a}from"./index-Ii50jS8z.js";const B={class:"guide-cont"},F={class:"guide-cont"},R={class:"guide-cont"},T={class:"guide-cont"},y={__name:"GuideCalendar",setup(j){const g=m("2026-03-16"),c=e=>{console.log(e)},i=m({minDate:null,maxDate:null}),v=()=>{let e=20,n=24;const t=new Date,k=new Date(new Date(t).setDate(new Date(t).getDate()-e)),w=new Date(new Date(t).setDate(new Date(t).getDate()+n)),f=d=>{const b=d.getFullYear(),C=String(d.getMonth()+1).padStart(2,"0"),S=String(d.getDate()).padStart(2,"0");return`${b}-${C}-${S}`};i.value.minDate=f(k),i.value.maxDate=f(w)},u=m({start:"2026-02-14",end:"2026-03-15"}),D=m(M(()=>`${u.value.start} ~ ${u.value.end}`));return x(()=>{v()}),(e,n)=>(V(),$(P,null,[n[8]||(n[8]=s("h3",{class:"guide-stitle"},"Default",-1)),s("div",B,[l(r,{id:"CalSample1",onCalAct:c}),l(o,{id:"CalendarBasic"},{accoTitle:p(()=>[...n[0]||(n[0]=[a("Code 보기",-1)])]),accoPanel:p(()=>[...n[1]||(n[1]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"comment"},"// component import"),a(`
