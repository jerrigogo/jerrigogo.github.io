import{_ as t}from"./AccordionComp-yubwh0wW.js";import{_ as o}from"./CalendarComp-DIR21KDB.js";import{r,e as M,v as x,c as _,a as s,b as l,j as m,F as $,o as P,k as a}from"./index-_T-uBsW5.js";const V={class:"guide-cont"},B={class:"guide-cont"},F={class:"guide-cont"},h={class:"guide-cont"},y={__name:"GuideCalendar",setup(R){const g=r("2026-03-16"),p=c=>{console.log(c)},i=r({minDate:null,maxDate:null}),v=()=>{let c=20,n=24;const e=new Date,k=new Date(new Date(e).setDate(new Date(e).getDate()-c)),w=new Date(new Date(e).setDate(new Date(e).getDate()+n)),f=d=>{const b=d.getFullYear(),C=String(d.getMonth()+1).padStart(2,"0"),S=String(d.getDate()).padStart(2,"0");return`${b}-${C}-${S}`};i.value.minDate=f(k),i.value.maxDate=f(w)},u=r({start:"2026-02-14",end:"2026-03-15"}),D=r(M(()=>`${u.value.start} ~ ${u.value.end}`));return x(()=>{v()}),(c,n)=>(P(),_($,null,[n[4]||(n[4]=s("h3",{class:"guide-stitle"},"Default",-1)),s("div",V,[l(o,{id:"CalSample1",onCalAct:p}),l(t,{id:"CalendarBasic","acco-title":"Code 보기"},{accoPanel:m(()=>[...n[0]||(n[0]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"comment"},"// component import"),a(`
`),s("span",{class:"import"},"import"),a(),s("span",{class:"props"},"CalendarComp"),a(),s("span",{class:"import"},"from"),a(),s("span",{class:"val"},"'@/components/CalendarComp.vue'"),a(`;
...
`),s("span",{class:"tag"},"const"),a(),s("span",{class:"func"},"selectDate"),a(" = "),s("span",{class:"mark"},[a("("),s("span",{class:"props"},"obj"),a(")")]),a(),s("span",{class:"tab"},"=>"),a(),s("span",{class:"mark"},"{"),a(`
    ...
    ...
`),s("span",{class:"mark"},"}"),a(`;
`)])],-1),s("div",{class:"guide-info html"},[s("pre",null,[a(""),s("span",{class:"arrow"},"<"),s("span",{class:"component"},"calendar-comp"),a(`
...
`)])],-1)])]),_:1})]),n[5]||(n[5]=s("h3",{class:"guide-stitle"},"Checked date (예: 2026-03-16)",-1)),s("div",B,[l(o,{id:"CalSample2","define-date":g.value,onCalAct:p},null,8,["define-date"]),l(t,{id:"CalendarChecked","acco-title":"Code 보기"},{accoPanel:m(()=>[...n[1]||(n[1]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"comment"},"// 날짜 지정 예시"),a(`
...
`),s("span",{class:"arrow"},"<"),s("span",{class:"component"},"calendar-comp"),a(`
  `),s("span",{class:"props"},"id"),a("="),s("span",{class:"val"},'"CalSample1"'),a(`
  :`),s("span",{class:"props"},"define-date"),a('="'),s("span",{class:"props"},"sampleDefineDate"),a(`"
  @`),s("span",{class:"props"},"cal-act"),a('="'),s("span",{class:"func"},"selectDate"),a(`"
`),s("span",{class:"arrow"},"/>"),a(`
`)])],-1)])]),_:1})]),n[6]||(n[6]=s("h3",{class:"guide-stitle"},"날짜 제한 설정: minDate, maxDate",-1)),s("div",F,[l(o,{id:"CalSample3","limit-date":i.value,onCalAct:p},null,8,["limit-date"]),l(t,{id:"CalendarLimit","acco-title":"Code 보기"},{accoPanel:m(()=>[...n[2]||(n[2]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"import"},"import"),a(),s("span",{class:"mark"},"{"),a(),s("span",{class:"props"},"ref"),a(", "),s("span",{class:"props"},"onBeforeMount"),a(),s("span",{class:"mark"},"}"),a(" = "),s("span",{class:"val"},"'vue'"),a(`;
...
`),s("span",{class:"arrow"},"<"),s("span",{class:"component"},"calendar-comp"),a(`
  ...
  @`),s("span",{class:"props"},"cal-act"),a('="'),s("span",{class:"func"},"selectDate"),a(`"
`),s("span",{class:"arrow"},"/>"),a(`
`)])],-1)])]),_:1})]),n[7]||(n[7]=s("h3",{class:"guide-stitle"},"날짜 영역(기간) 선택",-1)),s("div",h,[l(o,{id:"CalSample4",range:u.value,"define-date":D.value,onCalAct:p},null,8,["range","define-date"]),l(t,{id:"CalendarPeriod","acco-title":"Code 보기"},{accoPanel:m(()=>[...n[3]||(n[3]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"comment"},"// 날짜 범위 샘플"),a(`
