import{_ as c}from"./CalendarItem-CYZL6zDH.js";import{r as e,f as s,c as d,a as t,e as l,d as o,o as m}from"./index-IN-5UTd3.js";const u={class:"main-contents"},i=o(`<h2 class="guide-title">Calendar</h2><div class="guide-info">※ Vuetify component 미사용</div><h3 class="guide-stitle">1. Basic</h3><div class="guide-info script"><pre><span class="comment">// component import</span>
...
</pre></div>`,5),k={class:"guide-cont"},f=o(`<h3 class="guide-stitle">2. Checked date (예: 2024-07-15)</h3><div class="guide-info script"><pre><span class="comment">// 선택한 날짜(예: 2024년 7월 15일)</span>
...
</pre></div>`,3),g={class:"guide-cont"},q={__name:"GuideCalendar",setup(h){const a=e({year:s(()=>new Date().getFullYear()),month:s(()=>new Date().getMonth()+1),date:s(()=>new Date().getDate())}),n=p=>{console.log(p)},r=e({year:2024,month:7,date:15});return(p,v)=>(m(),d("div",u,[i,t("div",k,[l(c,{id:"CalSample1","setup-date":a.value,onCalAct:n},null,8,["setup-date"])]),f,t("div",g,[l(c,{id:"CalSample2","setup-date":a.value,"checked-date":r.value,onCalAct:n},null,8,["setup-date","checked-date"])])]))}};export{q as default};
