import{_ as t}from"./CollapseComp-CO3-BEaq.js";import{_ as o}from"./CalendarComp-CouRq6dA.js";import{r,e as M,v as x,c as _,a as s,b as l,j as m,F as $,o as V,k as a}from"./index-CWx3Oa3O.js";const B={class:"guide-cont"},F={class:"guide-cont"},P={class:"guide-cont"},h={class:"guide-cont"},y={__name:"GuideCalendar",setup(R){const g=r("2026-03-16"),p=c=>{console.log(c)},i=r({minDate:null,maxDate:null}),v=()=>{let c=20,n=24;const e=new Date,k=new Date(new Date(e).setDate(new Date(e).getDate()-c)),w=new Date(new Date(e).setDate(new Date(e).getDate()+n)),f=d=>{const b=d.getFullYear(),C=String(d.getMonth()+1).padStart(2,"0"),S=String(d.getDate()).padStart(2,"0");return`${b}-${C}-${S}`};i.value.minDate=f(k),i.value.maxDate=f(w)},u=r({start:"2026-02-14",end:"2026-03-15"}),D=r(M(()=>`${u.value.start} ~ ${u.value.end}`));return x(()=>{v()}),(c,n)=>(V(),_($,null,[n[4]||(n[4]=s("h3",{class:"guide-stitle"},"Default",-1)),s("div",B,[l(o,{id:"CalSample1",onCalAct:p}),l(t,{id:"CalendarBasic",title:"Code 보기"},{panel:m(()=>[...n[0]||(n[0]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"comment"},"// component import"),a(`
...
`)])],-1)])]),_:1})]),n[5]||(n[5]=s("h3",{class:"guide-stitle"},"Checked date (예: 2026-03-16)",-1)),s("div",F,[l(o,{id:"CalSample2","define-date":g.value,onCalAct:p},null,8,["define-date"]),l(t,{id:"CalendarChecked",title:"Code 보기"},{panel:m(()=>[...n[1]||(n[1]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"comment"},"// 날짜 지정 예시"),a(`
...
`),s("span",{class:"arrow"},"<"),s("span",{class:"component"},"calendar-comp"),a(`
  ...
  @`),s("span",{class:"props"},"cal-act"),a('="'),s("span",{class:"func"},"selectDate"),a(`"
`),s("span",{class:"arrow"},"/>"),a(`
`)])],-1)])]),_:1})]),n[6]||(n[6]=s("h3",{class:"guide-stitle"},"날짜 제한 설정: minDate, maxDate",-1)),s("div",P,[l(o,{id:"CalSample3","limit-date":i.value,onCalAct:p},null,8,["limit-date"]),l(t,{id:"CalendarLimit",title:"Code 보기"},{panel:m(()=>[...n[2]||(n[2]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"import"},"import"),a(),s("span",{class:"mark"},"{"),a(),s("span",{class:"props"},"ref"),a(", "),s("span",{class:"props"},"onBeforeMount"),a(),s("span",{class:"mark"},"}"),a(" = "),s("span",{class:"val"},"'vue'"),a(`;
...
`),s("span",{class:"arrow"},"<"),s("span",{class:"component"},"calendar-comp"),a(`
  ...
  @`),s("span",{class:"props"},"cal-act"),a('="'),s("span",{class:"func"},"selectDate"),a(`"
`),s("span",{class:"arrow"},"/>"),a(`
`)])],-1)])]),_:1})]),n[7]||(n[7]=s("h3",{class:"guide-stitle"},"날짜 영역(기간) 선택",-1)),s("div",h,[l(o,{id:"CalSample4",range:u.value,"define-date":D.value,onCalAct:p},null,8,["range","define-date"]),l(t,{id:"CalendarPeriod",title:"Code 보기"},{panel:m(()=>[...n[3]||(n[3]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"comment"},"// 날짜 범위 샘플"),a(`
