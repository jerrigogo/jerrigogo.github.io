import{u as b,o as v,c as y,a as s,b as c,j as n,k as a,t as T,F as C,l as S,e as x}from"./index-BgYDIhlG.js";import{u as M}from"./dialog-DdmNxdP5.js";import{_ as u}from"./AccordionItem-DnuBm0jG.js";import{_ as g}from"./TooltipItem-DZOsjchS.js";import"./chkDevice-JsPLcLRz.js";const w={class:"modal-header"},O=["id"],I=["id"],$={class:"modal-body-inner"},D=["for"],A=["id"],j={__name:"ModalSample",props:{modalId:{type:String},modalType:{type:String},modalData:{type:Object}},setup(f){const e=b(),{alert:r,confirm:m}=M(),o=f,i=async()=>{await m({modalId:"ConfirmModal",modalType:"confirm",modalCont:"진행하시겠습니까?",modalOkText:"",modalCancelText:""})?await r({modalId:"AlertModal",modalType:"alert",modalCont:"완료되었습니다.",modalOkText:"",modalOkAct:()=>{console.log("alert ok!!")}}):console.log("confirm cancel!!")};function d(){e.close()}function t(p){i()}return(p,l)=>(v(),y(C,null,[s("header",w,[s("h1",{id:`${o.modalId}_title`,class:"modal-title"},[c(g,{id:"TipSample1","tip-title":"Modal Test"},{default:n(()=>[...l[0]||(l[0]=[s("p",null,"개인정보 처리목적 : 보험계약 상담, 보험계약 인수여부 결정을 위한 판단 등",-1)])]),_:1})],8,O)]),s("div",{id:`${o.modalId}_desc`,class:"modal-body"},[s("div",$,[s("p",null,[a(" receive data : "+T(o.modalData),1),l[2]||(l[2]=s("br",null,null,-1)),l[3]||(l[3]=s("br",null,null,-1)),l[4]||(l[4]=a(" Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ",-1)),l[5]||(l[5]=s("a",{href:"#"},"anchor",-1)),l[6]||(l[6]=s("br",null,null,-1)),l[7]||(l[7]=s("button",{type:"button"},"button",-1)),l[8]||(l[8]=s("br",null,null,-1)),c(g,{id:"TipSample2","tip-title":"개인정보 처리목적","tip-click":!0},{default:n(()=>[...l[1]||(l[1]=[s("p",null,"개인정보 처리목적 : 보험계약 상담, 보험계약 인수여부 결정을 위한 판단 등",-1)])]),_:1}),l[9]||(l[9]=a(" input ",-1)),s("label",{for:`${o.modalId}-inpName`},"Name",8,D),s("input",{type:"text",id:`${o.modalId}-inpName`,name:"name",placeholder:"example..",autocomplete:"off"},null,8,A),l[10]||(l[10]=s("br",null,null,-1)),l[11]||(l[11]=a(" textarea ",-1)),l[12]||(l[12]=s("textarea",{name:"textarea"},null,-1)),l[13]||(l[13]=s("br",null,null,-1)),l[14]||(l[14]=a(" Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ",-1))])])],8,I),s("footer",{class:"modal-footer"},[s("button",{type:"button",class:"modal-btn-gray",onClick:d},[...l[15]||(l[15]=[s("span",null,"취소",-1)])]),s("button",{type:"button",class:"modal-btn-primary",onClick:t},[...l[16]||(l[16]=[s("span",null,"확인",-1)])])])],64))}},q={class:"contents"},N={class:"guide-cont"},B={class:"guide-cont"},L={class:"guide-cont type-row"},F={class:"guide-cont"},z={__name:"GuideModal",setup(f){const e=b(),{alert:r,confirm:m}=M(),o=()=>{r({modalId:"AlertModal",modalCont:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.",modalOkText:"",modalOkAct:()=>{console.log("alert ok!!")}})},i=async()=>{await m({modalId:"ConfirmModal",modalCont:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br /> Do you want to ... ?",modalOkText:"",modalCancelText:""})?await r({modalId:"AlertModal",modalCont:"Lorem ipsum dolor sit amet, consectetur adipiscing elit.",modalOkText:"",modalOkAct:()=>{console.log("alert ok!!")}}):console.log("confirm cancel!!")},d=x([{label:"sample",value:"1"}]),t=p=>{e.open(j,{modalId:p.id,modalType:p.type,modalData:d})};return S(()=>{}),(p,l)=>(v(),y("div",q,[l[14]||(l[14]=s("h2",{class:"guide-title"},"Modal",-1)),l[15]||(l[15]=s("h3",{class:"guide-stitle"},"Alert modal",-1)),s("div",{class:"guide-cont type-row"},[s("button",{type:"button",class:"btn-primary",onClick:o},[...l[3]||(l[3]=[s("span",null,"Alert dialog",-1)])])]),s("div",N,[c(u,{id:"ModalAlert"},{accoTitle:n(()=>[...l[4]||(l[4]=[a("Code 보기",-1)])]),accoPanel:n(()=>[...l[5]||(l[5]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"comment"},"// modal store 파일 및 alert/confirm 관련 util js 파일 import"),a(`
...
`),s("span",{class:"tag"},"const"),a(),s("span",{class:"func"},"alertModal"),a(" = "),s("span",{class:"mark"},"()"),a(),s("span",{class:"tag"},"=>"),a(),s("span",{class:"mark"},"{"),a(`
  ...
  `),s("span",{class:"func"},")"),a(`;
`),s("span",{class:"mark"},"}"),a(`;
`)])],-1)])]),_:1})]),l[16]||(l[16]=s("h3",{class:"guide-stitle"},"Confirm modal",-1)),s("div",{class:"guide-cont type-row"},[s("button",{type:"button",class:"btn-primary",onClick:i},[...l[6]||(l[6]=[s("span",null,"Confirm dialog",-1)])])]),s("div",B,[c(u,{id:"ModalConfirm"},{accoTitle:n(()=>[...l[7]||(l[7]=[a("Code 보기",-1)])]),accoPanel:n(()=>[...l[8]||(l[8]=[s("div",{class:"guide-info script"},[s("pre",null,[a(""),s("span",{class:"comment"},"// modal store 파일 및 alert/confirm 관련 util js 파일 import"),a(`
`),s("span",{class:"import"},"import"),a(),s("span",{class:"mark"},[a("{ "),s("span",{class:"props"},"useDialog"),a(" }")]),a(),s("span",{class:"import"},"from"),a(),s("span",{class:"val"},"'@/assets/js/dialog'"),a(`;
...
`),s("span",{class:"tag"},"const"),a(),s("span",{class:"func"},"confirmModal"),a(" = "),s("span",{class:"tag"},[a("async "),s("span",{class:"mark"},"()"),a(" =>")]),a(),s("span",{class:"mark"},"{"),a(`
  ...
  `),s("span",{class:"func"},"}"),a(`
`),s("span",{class:"mark"},"}"),a(`;
`)])],-1)])]),_:1})]),l[17]||(l[17]=s("h3",{class:"guide-stitle"},"Normal modal",-1)),s("div",L,[s("button",{type:"button",class:"btn-primary","aria-haspopup":"dialog","aria-controls":"SampleModal",onClick:l[0]||(l[0]=k=>t({id:"SampleModal",type:"full"}))},[...l[9]||(l[9]=[s("span",null,"Type: Full",-1)])]),s("button",{type:"button",class:"btn-primary","aria-haspopup":"dialog","aria-controls":"SampleTopModal",onClick:l[1]||(l[1]=k=>t({id:"SampleTopModal",type:"top"}))},[...l[10]||(l[10]=[s("span",null,"Type: Top",-1)])]),s("button",{type:"button",class:"btn-primary","aria-haspopup":"dialog","aria-controls":"SampleBottomModal",onClick:l[2]||(l[2]=k=>t({id:"SampleBottomModal",type:"bottom"}))},[...l[11]||(l[11]=[s("span",null,"Type: Bottom",-1)])])]),s("div",F,[c(u,{id:"Modal"},{accoTitle:n(()=>[...l[12]||(l[12]=[a("Code 보기",-1)])]),accoPanel:n(()=>[...l[13]||(l[13]=[s("div",{class:"guide-info html"},[s("pre",null,[a(""),s("span",{class:"arrow"},"<"),s("span",{class:"tag"},"button"),a(`
