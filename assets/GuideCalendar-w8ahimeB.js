import{_ as c}from"./CalendarItem-Cr903AxY.js";import{d as e,e as s,o as m,c as d,b as t,a as l,x as o}from"./index-DETIen2Z.js";const u={class:"contents"},i=o(`<h2 class="guide-title">Calendar</h2><h3 class="guide-stitle">1. Basic</h3><div class="guide-info script"><pre><span class="comment">// component import</span>
...
</pre></div>`,3),f={class:"guide-cont"},q={__name:"GuideCalendar",setup(h){const a=e({year:s(()=>new Date().getFullYear()),month:s(()=>new Date().getMonth()+1),date:s(()=>new Date().getDate())}),n=p=>{console.log(p)},r=e({year:2024,month:7,date:15});return(p,_)=>(m(),d("div",u,[i,t("div",k,[l(c,{id:"CalSample1","setup-date":a.value,onCalAct:n},null,8,["setup-date"])]),g,t("div",f,[l(c,{id:"CalSample2","setup-date":a.value,"checked-date":r.value,onCalAct:n},null,8,["setup-date","checked-date"])])]))}};export{q as default};
